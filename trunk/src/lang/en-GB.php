...
define("_LANG_CONFIG_TIMEZONE", "Time zone");
define("_LANG_CONFIG_DEBUG", "Debug");
define("_LANG_CONFIG_LOG_LEVEL", "Log level");
define("_LANG_CONFIG_LOG_FILE", "Full path to log file");
...
define("_LANG_CONFIG_MAX_UPLOAD_SIZE", "Maximum upload size");
...
define("_LANG_USER_EMAIL_NOTIFICATIONS", "Email notifications");
define("_LANG_USER_SHOW_EMAIL", "Show email address to other users");
define("_LANG_USERS_NO_SELECTED", "No user has been selected");
...
define("_LANG_PROJECTS_ACCESS_MESSAGES", "Messages access");
define("_LANG_PROJECTS_ACCESS_MILESTONES", "Milestones access");
define("_LANG_PROJECTS_ACCESS_FILES", "Files access");
define("_LANG_PROJECTS_ACCESS_MEETINGS", "Meetings access");
define("_LANG_PROJECTS_ACCESS_POLLS", "Polls access");
...
define("_LANG_PROJECTS_STATUS_PAUSED", "Paused");
define("_LANG_PROJECTS_STATUS_FINISHED", "Finished");
define("_LANG_PROJECTS_STATUS_ARCHIVED", "Archived");
...
define("_LANG_PROJECTS_INVITATION_BODY", "%s has added you to the following project: 
...
URL: %s
");
define("_LANG_PROJECTS_INVITATION_NEW_USER_BODY", "Invitation sent by: %s
...
define("_LANG_PROJECT_MEMBER_ROLE_SAVE_ERROR", "An error occurred while changing member's role");
