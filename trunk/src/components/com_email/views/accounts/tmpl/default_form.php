...
<div id="accordion">
	...
	<div>
		...
		<tr>
			<td><?php echo PHPFrame_Base_String::html( _LANG_EMAIL_SERVER_TYPE ); ?></td>
			<td>
	...
	<div>
		...
		<tr>
			<td><?php echo PHPFrame_Base_String::html( _LANG_EMAIL_ADDRESS ); ?></td>
...
<button type="button" onclick="window.location = 'index.php?component=com_email&view=accounts';"><?php echo PHPFrame_Base_String::html(_LANG_BACK); ?></button>
