...
html::validate('email_accountsform');
?>
...
<div id="accordion">
	...
	<div>
		...
		<tr>
			<td><?php echo text::_( _LANG_EMAIL_SERVER_TYPE ); ?></td>
			<td>
	...
	<div>
		...
		<tr>
			<td><?php echo text::_( _LANG_EMAIL_ADDRESS ); ?></td>
...
<button type="button" onclick="window.location = 'index.php?option=com_email&view=accounts';"><?php echo text::_(_LANG_BACK); ?></button>
