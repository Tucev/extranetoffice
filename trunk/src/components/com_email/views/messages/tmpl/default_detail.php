...
<div id="email_detail_actions">
    <div>
        ...
        <img border="0" src="templates/<?php echo PHPFrame::Config()->get("THEME"); ?>/images/icons/generic/32x32/back.png" alt="<?php echo PHPFrame_Base_String::html( _LANG_BACK ); ?>" />
        </a>
    </div>
    <div>
        ...
        <img border="0" src="templates/<?php echo PHPFrame::Config()->get("THEME"); ?>/images/icons/email/32x32/mail_reply-32x32.png" alt="<?php echo _LANG_REPLY; ?>" title="<?php echo _LANG_REPLY; ?>" />
        </a>
    </div>
    <div>
        ...
        <img border="0" src="templates/<?php echo PHPFrame::Config()->get("THEME"); ?>/images/icons/email/32x32/mail_replyall-32x32.png" alt="<?php echo _LANG_REPLY_TO_ALL; ?>" title="<?php echo _LANG_REPLY_TO_ALL; ?>" />
        </a>
    </div>
    <div>
        ...
        <img border="0" src="templates/<?php echo PHPFrame::Config()->get("THEME"); ?>/images/icons/email/32x32/mail_forward-32x32.png" alt="<?php echo _LANG_FORWARD; ?>" title="<?php echo _LANG_FORWARD; ?>" />
        </a>
    </div>
    <div>
    ...
    <div>
        ...
        <img border="0" src="templates/<?php echo PHPFrame::Config()->get("THEME"); ?>/images/icons/email/32x32/mail_delete-32x32.png" alt="<?php echo _LANG_DELETE; ?>" title="<?php echo _LANG_DELETE; ?>" />
        </a>
    </div>
     -->
</div>
...
<?php for ($x=0; $x<count($this->message['attachments']); $x++) : ?>
    ...
    <a href="index.php?component=com_email&amp;action=download_attachment&amp;view=email&folder=<?php echo $this->folder; ?>&amp;file_name=<?php echo $attachment['file_name']; ?>&amp;msgno=<?php echo $this->message['msgno'] ?>&amp;file=<?php echo $x; ?>">
    <?php echo $attachment['file_name']; ?>
    </a> - <?php echo PHPFrame_Base_Number::bytes($attachment['file_size']); ?> <br />
    <?php endif; ?>
<?php endfor; ?>
</td>
</tr>
