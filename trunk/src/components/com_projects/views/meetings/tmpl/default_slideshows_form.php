...
<tr>
	...
	<?php else : ?>
		...
		<?php phpFrame_HTML::upload(array('option'=>'com_projects', 
						   ...
						   <br />\
						   <a href=\"'.phpFrame_Application_Route::_("index.php?option=com_projects&task=remove_slide&projectid=".$this->projectid."&meetingid=".$this->row->meetingid."&slideshowid=".$this->row->id."&slideid=\"+response+\"").'\">Delete</a>\
						   </div>");'
		); ?>
		<hr />
		...
		<br />
		<a href="<?php echo phpFrame_Application_Route::_("index.php?option=com_projects&task=remove_slide&projectid=".$this->projectid."&meetingid=".$this->row->meetingid."&slideshowid=".$slide->slideshowid."&slideid=".$slide->id); ?>">Delete</a>
		</div>
		<?php endforeach; ?>
		<?php else : ?>
