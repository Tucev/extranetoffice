...
<div class="ioffice_thread_row0">
	...
	<div style="float: left; padding: 0 3px 0 0; ">
		<img height="48" width="48" src="templates/default/icons/mimetypes/32x32/<?php echo projectsHelperProjects::mimetype2icon($this->row->mimetype); ?>" alt="<?php echo $this->row->mimetype; ?>" />
	</div>
	...
	<div id="oldrevisions<?php echo $this->row->id; ?>" class="ioffice_thread_oldrevisions">
